...
import com.moblong.flipped.util.DBHelper;
import com.moblong.flipped.util.DatabaseHelper;
import com.moblong.flipped.util.PingYinUtil;
import com.moblong.flipped.wedget.MyLetterListView;
import com.moblong.flipped.wedget.MyLetterListView.OnTouchingLetterChangedListener;

public class LocalCityActivity extends Activity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.localcity_layout);
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					LocalCityActivity.this.setResult(RESULT_OK, data);
	...
	private ArrayList<City> getCityList() {
		...
		Shell shell = (Shell) getApplication();
		try {
			dbHelper.createDataBase(shell.databases());
